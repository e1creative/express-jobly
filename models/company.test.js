...
describe("findAll", function () {
  ...
  test("works: filters", async function () {
    const filter1 = { filters: { nameLike: "%c%"}}
    let companies = await Company.findAll(filter1)
    expect(companies).toEqual([
      {
        handle: "c1",
        name: "C1",
    ...
    const filter2 = { filters: { nameLike: "%2%"}}
    let companies2 = await Company.findAll(filter2)
